...
public class ApiVariant {
	...
	public interface ReadGenericInterface<E> {
		public void read(DataInputStream in, E e, int index) throws IOException;		
	}
	public static <E> E arrayRead(DataInputStream dataInputStream, 
			IntFunction<E> array, ReadGenericInterface<E> consumer) throws IOException {
	...
	public static <E> E[] read(DataInputStream dataInputStream, 
			IntFunction<E[]> factory, ReadInterface<E> provider) throws IOException {
		return arrayRead(dataInputStream, factory, 
				(in, a, i) -> a[i] = provider.read(in));
	}
	...
	public interface WriteGenericInterface<E> {
		public void write(DataOutputStream out, E e, int index) throws IOException;
	}
	...
	public static <E> void arrayWrite(DataOutputStream dataOutputStream, E array, 
			int length, WriteGenericInterface<E> genericWrite) throws IOException {
	...
	public static <E> void write(DataOutputStream dataOutputStream, 
		...
		arrayWrite(dataOutputStream, data, data.length, 
				(out, a, i) -> consumer.write(out, a[i]));
	}
